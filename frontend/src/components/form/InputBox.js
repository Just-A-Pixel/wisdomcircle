    ...
    return (
        ...
        <div className="flex">
            <input
                ...
                } font-sans text-[14px] px-[16px] py-[12px] w-[320px] mt-[16px] border ${isValid?"border-gray-80  focus:border-black":"border-red focus:border-red text-red"} focus:outline-none`}
            />
            {type === "password" ? (
                <span
